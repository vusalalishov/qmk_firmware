...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
	     ...
	     KC_RGUI , KC_Z      , KC_X , KC_C    , KC_V     , KC_B    , XXXXXXX  , XXXXXXX , /**/ XXXXXXX    , XXXXXXX     , KC_N    , KC_M    , TD_DOT , TD_UNDS , KC_SLSH       , XXXXXXX ,
    ...
    [_SYM] = LAYOUT(
	     _______ , _______ , _______ , _______ , _______ , _______ ,                     /**/                     KC_LPRN , KC_LCBR           , KC_RCBR        , _______    , _______ , _______ ,
	     _______ , _______ , _______ , _______ , _______ , _______ ,                     /**/                     KC_RPRN , LGUI(KC_LEFT)     , LGUI(KC_RIGHT) , _______    , KC_COLN , _______ ,
